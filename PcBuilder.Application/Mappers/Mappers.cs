...
{
    public static ComponenteResponse ToResponse(this Componente c) => new(
        c.Id,
        c.Nombre,
        c.Descripcion,
        c.Sku,
    ...
    public static ConfiguracionPCResponse ToResponse(this ConfiguracionPC c) => new(
        c.Id,
        c.Nombre,
        c.EstaFinalizada,
        c.PrecioTotal,
    ...
    public static PedidoResponse ToResponse(this Pedido p) => new(
        p.Id,
        p.NumeroPedido,
        p.Estado.ToString(),
        p.DireccionEnvio,
